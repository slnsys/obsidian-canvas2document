...
interface Canvas2DocumentSettings {
	mySetting: string;
}

const DEFAULT_SETTINGS: Canvas2DocumentSettings = {
	mySetting: 'default'
}

export default class Canvas2DocumentPlugin extends Plugin {
	settings: Canvas2DocumentSettings;
	fsadapter: FileSystemAdapter;

	async onload() {
		await this.loadSettings();
		//check the following with instance of
		...
		// this.fsadapter = this.app.vault.adapter as FileSystemAdapter;
		 if (this.app.vault.adapter instanceof FileSystemAdapter) {
			...
			// throw exception for fsadapter
			console.log("no FileSystemAdapter found")
			return
		 }
	...
	async writeCanvDocFile(content, convStruct) {
		...
		let contentString = "This is an automatically generated document generated by Plugin [Canvas2Document](https://google.de)\n\n"
